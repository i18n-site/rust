...
pub const MIRROR: &[(bool, &str)] = &[
  ...
  (false, "jsd.onmicrosoft.cn/gh/i18n-site/dist@"),
  (true, "cdn.jsdelivr.net/gh/i18n-site/dist@"),
  (false, "jsd.cdn.zzko.cn/gh/i18n-site/dist@"),
  (true, "fastly.jsdelivr.net/gh/i18n-site/dist@"),
